...
DEFAULTS = {
    ...
    "steady_state_atol": 0.0,  # Absolute steady-state tolerance on ||g_ss||
    "steady_state_rtol": 1e-3,  # Relative steady-state tolerance on ||g_ss||
    "n_plateau_required": 20,  # Consecutive plateau steps before reporting stagnation
    "plateau_tol": 0.02,  # Reduction band treated as a residual plateau
